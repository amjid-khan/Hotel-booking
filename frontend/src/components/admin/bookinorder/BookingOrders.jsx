...
const filteredBookings = useMemo(
  ...
  return (
    <div className="min-h-screen bg-gray-50 md:pl-64 pt-16 md:pt-0">
        ...
        <div className="px-4 md:px-8 py-6">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600 mt-1">
                  {user?.role === "user" ? "Track your reservations" : "Manage hotel bookings"}
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-6">
            ...
            <div className="bg-white rounded-2xl p-4 sm:p-6 border border-gray-200 shadow-sm">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-gray-600 text-sm font-medium">Average Booking</p>
                  <p className="text-xl sm:text-2xl font-bold text-gray-900 mt-1">{formatCurrency(stats.avgAmount)}</p>
                </div>
            ...
            <div className="bg-white rounded-2xl p-4 sm:p-6 border border-gray-200 shadow-sm">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xl sm:text-2xl font-bold text-gray-900 mt-1">{stats.thisMonth}</p>
                </div>
      ...
      {/* Content */}
      <div className={`p-4 md:p-8 transition-all duration-300 ${viewingBooking ? 'blur-sm' : ''}`}>
        {loading ? (
                  ...
                  <div key={booking.id} className="bg-white border border-gray-200 rounded-2xl p-4 sm:p-6 hover:shadow-md transition-shadow">
                    ...
                    <div className="space-y-2 sm:space-y-3 mb-4">
                      <div className="flex items-center gap-2 text-xs sm:text-sm text-gray-600">
                        ...
                        <span className="truncate">{booking.roomName || `Room ${booking.roomId}`}</span>
                      </div>
                      {booking.hotelName && (
                        <div className="flex items-center gap-2 text-xs sm:text-sm text-gray-600">
          ...
          <div className="bg-white rounded-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-6 space-y-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h3 className="text-xl font-bold text-gray-900">{viewingBooking.guestName}</h3>
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center gap-2">
                      ...
                      <span>{viewingBooking.roomName || `Room ${viewingBooking.roomId}`}</span>
                    </div>
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span>{viewingBooking.guests} Guest{viewingBooking.guests > 1 ? 's' : ''}</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center gap-2">
                      ...
                      <span>Check-in: {formatDate(viewingBooking.checkIn)}</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <Calendar className="w-4 h-4 text-red-500" />
                      <span>Check-out: {formatDate(viewingBooking.checkOut)}</span>
                    </div>
                  </div>
                </div>
              </div>
