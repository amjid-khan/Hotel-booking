...
const AdminNavbar = () => {
  ...
  return (
    <>
      {/* Mobile overlay - reduced opacity for lighter blur */}
      <div
      ...
      >
        ...
        {user && (
          <div className="px-6 py-5 border-b border-gray-100 bg-gradient-to-r from-gray-50/50 to-blue-50/30">
            ...
            <div className="space-y-3">
              ...
              {/* Hotel Selector Dropdown - Enhanced */}
              {hotels.length > 0 && (
        ...
        {/* Professional Logout Button - Enhanced */}
      ...
      {/* Professional Logout Confirmation Modal - Light background blur */}
      {showLogoutConfirm && (
